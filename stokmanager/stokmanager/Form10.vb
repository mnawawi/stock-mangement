Public Class Form10
    ...
    Private Sub Form10_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MetroLabel3.Text = Form7.MetroTextBox13.Text
        MetroLabel5.Text = Form7.MetroLabel1.Text
        terimaan()
        keluaran()
    End Sub
    Public Sub terimaan()
        ...
        oleConn.Open()
        da = New OleDb.OleDbDataAdapter("SELECT * FROM tambah WHERE kod LIKE '%" & Form7.MetroTextBox34.Text & "%'", oleConn)
        da.Fill(ds, "terimaan")
        oleConn.Close()
        ListView1.Clear()
        With ListView1
    ...
    Public Sub keluaran()
        ...
        oleConn.ConnectionString = My.Settings.manageConnectionString
        oleConn.Open()
        da = New OleDb.OleDbDataAdapter("SELECT * FROM kurang WHERE kod LIKE '%" & Form7.MetroTextBox34.Text & "%'", oleConn)
        da.Fill(ds, "keluaran")
        oleConn.Close()
        ListView2.Clear()
        With ListView2
